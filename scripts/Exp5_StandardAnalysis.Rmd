...
t.test(RT_ifo~Validity, data = Exp5_VoS_agg_fo, paired=TRUE)
```
...
This part of analysis involves looking at the data concerning the awareness guessing trtials and the questionnaire. 
...
pander(anova_VSA_fo, style = 'rmarkdown', caption = "ANOVA results with awareness: Farouts excluded for test trials",split.table = "Inf", missing = NA)
...
pander(anova_S_fo, style = 'rmarkdown', caption = "ANOVA results: Farouts excluded for test trials",split.table = "Inf", missing = NA)

ezStats(data = Exp5SalAware_agg,
        dv = RT_ifo,
        wid = participant,
        within_full = .(PosMatch,Validity),
        within = .(PosMatch),
